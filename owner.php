...
<div class="frm">
    <div>
        ...
        <form action="./Insert/insertOwner_owner.php" method="POST">
    ...
    <div>
        ...
        <form action="./Update/updateOwner_owner.php" method="POST">
    ...
    <div>
        ...
        <form action="./show/showLease_owner.php" method="POST">
    ...
    <div>
        ...
        <form action="./delete/deleteOwner_owner.php" method="POST">
