...
<nav class="navbar navbar-light bg-transparent">
    <div class="container-fluid">
        ...
        <h2 class="text-dark"> Sewana Property ( Property Owner) </h2>
        <form class="d-flex">
            <button type="button" class="d-block btn btn-primary m-3 w-100 p-4 "><a
                        class="text-decoration-none text-white" href="../owner.php">Go back</a></button>
        </form>
    </div>
</nav>
...
$quary = "  SELECT * FROM `property_requirement` ";
...
<div class="table-responsive">
    <table class="table-dark table-striped table-hover table-bordered border-light">
        <caption class="table-dark w-100">Property Requirement Details</caption>
        <thead>
        <th>Client Number </th>
        <th>Requirement Number </th>
        <th>Maximum Rental(Rs.)</th>
        <th>Type Of Property</th>
        <th>Date Willing To Rent</th>
        </thead>
        <?php
        while ($row = mysqli_fetch_array($records)) {
            ...
            <tr>
                ...
                <td><?php echo $row['maximum_rental']; ?></td>
                <td><?php echo $row['type_of_property']; ?></td>
                <td><?php echo $row['date_willing_to_rent']; ?></td>
            </tr>
